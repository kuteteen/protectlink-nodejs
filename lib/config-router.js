...
module.exports = (Router) => {
  ...
  Router.use('/login', middleware.auth.preLoginCheck)
  Router.use('/logout', middleware.auth.isAuthenticated)
  Router.use('/user', middleware.auth.isAuthenticated)
  Router.use('/link', middleware.auth.isAuthenticated)
