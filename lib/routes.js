...
Route.get('/link/:id/update/manual', (req, res) => {
  res.end('manual update postId')
})
Route.post('/link/:id/update', (req, res) => {
  res.end('posted to update')
})
Route.get('/link/:id/delete', controller.link.delete)
